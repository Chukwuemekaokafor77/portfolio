...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      'Production-ready multi-tenant SaaS platform for Canadian personal support agencies — PIPEDA-compliant with org-isolated tenancy, MFA-secured auth, GPS-verified task completion, real-time WebSocket messaging, digital MAR, bilingual EN/FR, and Stripe billing.',
    ...
    highlights: [
      '~1,040 backend + 890 frontend tests · 227 API endpoints',
      'PIPEDA-compliant · MFA (TOTP) · multi-tenant org isolation',
      '17-role RBAC · bilingual EN/FR · GPS-verified shifts',
      'App-layer PHI encryption + immutable audit log',
      'Digital MAR · real-time WebSocket messaging (Redis pub/sub)',
      'Payroll module + CSV export · Stripe billing',
      'JWT rotation · account lockout · 7 CI/CD workflows',
    ],
  },
  {
    id: 2,
  ...
  {
    id: 11,
    title: 'Maple Care LMS',
    description:
      'Multi-tenant compliance-training LMS for Atlantic-Canada long-term-care operators — per-seat SaaS with roster-CSV onboarding, inspector-ready PDF/CSV exports, PHIPAA per-record access logging, fail-closed tenant isolation, and statutory bilingual EN/FR delivery.',
    tags: ['Next.js', 'NestJS', 'Prisma', 'PostgreSQL', 'Stripe', 'Redis'],
    category: 'saas',
    github: 'https://github.com/Chukwuemekaokafor77/LMS',
    live: null,
    highlights: [
      'Multi-tenant SaaS · fail-closed tenant isolation (cross-tenant test suite)',
      'PHIPAA per-record access logging + append-only audit ledger',
      'Inspector-ready PDF/CSV exports · roster-CSV onboarding',
      'Bilingual EN/FR (statutory NB) · multi-jurisdiction catalog (NB/NS/PE/NL/ON)',
      'Stripe per-seat billing + Stripe Tax · Mux signed video playback',
      'Data residency in ca-central-1 (S3 + Postgres 16)',
      '17 Prisma models · 29 API endpoints · BullMQ job queue',
    ],
  },
  {
    id: 3,
